...
namespace FireWoodIntegrationTest
{
    ...
    public class ProductsTest : TestBase
    {
        ...
        // I also tried deleting and creating the views again but it didn't worked either.
        // This whole thing is working perfectly in ProductType Controller.
        // I will be really greatful if you can assist me with that file path thing.
       [TestMethod]
        public void ToTestWeatherProductDeleteOptionWorks()
        {
